...
<html lang="en">
  <head>
    <title>Bestdomainprice.net: Domain Price Compare</title>
    ...
    <script type="text/javascript" src="http://www.theclinicmanager.com/assets/js/wiselinks/wiselinks-1.2.2.min.js"></script>
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="tnav2">
                    ...
                    <div class="row">
                      ...
                      <div class="col-10">
                        <h1>Bestdomainprice.net - Why we built it?</h1>
          ...
          <div class="col-sm-3" style="margin-bottom: 10px;" align="center">
            <img src="img/250x250.jpg" class="img-fluid"/>
            <hr/>
            <img src="img/250x600.jpg" class="img-fluid"/>
          </div>
        </div>
      </div>
    </section>
    ...
    <footer class="page-footer font-small dark darken-3" style="background-color:#000; color:#fff; text-align:center;">
      ...
      <!-- Copyright -->
      <div class="footer-copyright text-center py-3">© 2018 Copyright: Bestdomainprice.net
      </div>
      <!-- Copyright -->
    </footer>
    <!-- Footer -->
